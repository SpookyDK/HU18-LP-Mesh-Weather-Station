...
esp_err_t onewire_bus_write_bytes(onewire_bus_handle_t bus,
    ...
    ESP_RETURN_ON_FALSE(bus && tx_data && tx_data_size, ESP_ERR_INVALID_ARG,
...
esp_err_t onewire_bus_read_bytes(onewire_bus_handle_t bus, uint8_t *rx_buf,
                                 size_t rx_buf_size) {
    ESP_RETURN_ON_FALSE(bus && rx_buf && rx_buf_size, ESP_ERR_INVALID_ARG, TAG,
                        "invalid argument");
...
esp_err_t onewire_bus_read_bit(onewire_bus_handle_t bus, uint8_t *rx_bit) {
    ESP_RETURN_ON_FALSE(bus && rx_bit, ESP_ERR_INVALID_ARG, TAG,
                        "invalid argument");
