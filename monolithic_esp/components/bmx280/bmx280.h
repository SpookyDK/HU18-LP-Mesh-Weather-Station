...
#define bmx280_create_legacy(port)                                                                                     \
    static_assert(0, "You have the wrong driver configuration for using the legacy I2C driver.")
#else
/**
 * Create an instance of the BMX280 driver.
...
#define bmx280_create_master(port)                                                                                     \
    static_assert(0, "You have the wrong driver configuration for using the new I2C master driver.")
#endif
