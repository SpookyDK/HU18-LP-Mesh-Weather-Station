...
dmi = pd.read_csv('DMI_PRESSURE.csv', sep=',', decimal='.')  # comma as separator, comma as decimal
...
plt.plot(our['TIME'], our['PRESSURE']/100, label='Measured Pressure', color='orange', linewidth=4)
plt.plot(dmi['DateTime'], dmi['Pressure'], label='DMI Pressure', color='green', linewidth = 4)
plt.axhline()
plt.ylim(1015, 1025)
