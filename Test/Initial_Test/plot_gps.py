...
plt.title('Distance from Reported Position to Actual Positions(Google Maps)', fontsize = 25)
plt.plot(our['TIME'], our['GPS DIF'], label='GPS Distance to Actual Location', color='orange', linewidth=4)
plt.axhline()
